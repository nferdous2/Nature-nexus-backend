  ...
  try {
    ...
    app.post("/purchase", async (req, res) => {
      ...
      const data = {
        ...
        success_url: `https://nature-nexus-backend-sable.vercel.app/payment/success/${tran_id}`,
        fail_url: `https://nature-nexus-backend-sable.vercel.app/payment/fail/${tran_id}`,
